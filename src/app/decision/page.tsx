      ...
      {step === 4 && (
        <div className="w-full pt-20 max-w-7xl mx-auto animate-in fade-in zoom-in-95 duration-1000 ease-out flex flex-col items-center">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 w-full max-w-5xl justify-items-center mb-32">
            {/* Primary Match injecting our DecisionCard identity */}
            <div className="col-span-1 lg:col-span-2 w-full max-w-lg shadow-[0_30px_60px_rgba(0,0,0,0.12)] rounded-[2.5rem] p-1 bg-linear-to-tr from-accent to-amber-500/50">
              <div className="bg-surface rounded-[2.2rem] h-full p-2 relative overflow-hidden flex flex-col">
                ...
                <DecisionCard
                  ...
                  highlights={[
                    ...
                    "Clean Android Build",
                    "Native Gemini Nanotensor",
                  ]}
                  href="/device/pixel-9-pro"
            ...
            {/* Runner up */}
            <div className="col-span-1 w-full max-w-md hidden lg:flex flex-col opacity-60 hover:opacity-100 transition-opacity duration-500 grayscale hover:grayscale-0">
              ...
              <DecisionCard
                ...
                brand="Samsung"
                score={91}
                price="$1299" // Notice how budget constraint was weighed
                highlights={[
                  "Anti-reflective Display",
                  "Integrated S-Pen",
                  "Periscope Telephoto",
                ]}
                href="/device/galaxy-s24-ultra"
              />
            </div>
          </div>
