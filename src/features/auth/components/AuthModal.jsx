        ...
        <AnimatePresence>
            {isOpen && (
                <>
                    ...
                    >
                        {/* HEADER */}
                        <div className="flex justify-between items-center p-6 border-b border-[var(--border-color)] bg-[var(--bg-main)]/50 backdrop-blur-sm">
                            ...
                            <button 
                                onClick={onClose} 
                                className="text-[var(--text-secondary)] hover:text-red-500 transition-colors p-2 hover:bg-red-500/10 rounded-full"
                            >
                                <X size={20} />
                            </button>
                        </div>
                        ...
                        <div className="p-8 md:p-10 flex-1 overflow-y-auto custom-scrollbar">
                            <div className="mb-8">
                                <h2 className="text-3xl md:text-4xl font-black italic uppercase tracking-tighter mb-2 text-[var(--text-primary)]">
                                    {isLogin ? "Welcome_Back" : "Join_Registry"}
                                </h2>
                                <p className="text-[10px] md:text-xs text-[var(--text-secondary)] font-mono uppercase tracking-widest">
                            ...
                            <button
                                ...
                                className="group w-full py-4 mb-8 rounded-xl border border-[var(--border-color)] bg-[var(--bg-main)] text-[var(--text-primary)] hover:border-cyan-500/50 hover:shadow-[0_0_20px_rgba(6,182,212,0.1)] transition-all duration-300 flex items-center justify-center gap-3 relative overflow-hidden"
                            >
                                ...
                                <Chrome size={18} className="text-[var(--text-secondary)] group-hover:text-cyan-400 transition-colors" />
                            ...
                            <div className="relative mb-8 text-center">
                                ...
                                <span className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 bg-[var(--bg-card)] px-3 text-[10px] font-mono uppercase text-[var(--text-secondary)] tracking-widest">
                                    Or_Decrypt_Manually
                                </span>
                            </div>
