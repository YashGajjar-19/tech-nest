...
export default function HeroAI ()
{
    return (
        <motion.div
            ...
            className="w-full max-w-xl mx-auto rounded-[2.5rem] bg-linear-to-b from-bg-card/80 to-bg-main/50 backdrop-blur-3xl border border-border-color p-1 overflow-hidden shadow-premium-xl group"
        >
